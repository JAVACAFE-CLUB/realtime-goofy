package com.goofy.realtime.collector

import com.goofy.realtime.collector.common.extension.Zone
...
@EnablePublisher
@EnableScheduling
@SpringBootApplication(scanBasePackages = ["com.goofy.realtime"])
class Application(
